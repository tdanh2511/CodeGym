...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/admin/product-list/styles.css">
...
<div id="header">
    ...
    <a href="${pageContext.request.contextPath}/" class="logout-button">Đăng xuất</a>
</div>
...
<div id="header2">
    ...
    <form action="adminProductsList" method="GET">
    ...
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/ad1.jpg" class="d-block w-100" alt="ad" style="width: 85%; height: 450px;">
            </div>
            <div class="carousel-item">
                <img src="images/ad2.jpg" class="d-block w-100" alt="ad" style="width: 85%; height: 450px;">
            </div>
            <div class="carousel-item">
                <img src="images/ad3.jpg" class="d-block w-100" alt="ad" style="width: 85%; height: 450px;">
            </div>
        </div>
    ...
    <div class="product-container">
        <c:forEach var="p" items="${listProducts}">
            <div class="product">
                ...
                <div class="btn-group mt-2" style="display: flex; justify-content: center; gap: 8px;">
                    <!-- Nút sửa -->
                    <a href="${pageContext.request.contextPath}/adminProductsList?action=update&id=${p.id}"
        ...
        <div class="product add-product" onclick="location.href='${pageContext.request.contextPath}/adminProductsList?action=create'">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Bạn có chắc muốn xoá sản phẩm <strong id="delName"></strong>?
            </div>
...
<script src="${pageContext.request.contextPath}/admin/product-list/main.js"></script>
</body>
</html>
